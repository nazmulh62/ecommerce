                                ...
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="{{url('/single')}}"><img src="{{asset('/front')}}/images/17.png" alt=" " class="img-responsive" /></a>
                        ...
                        <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                            ...
                            <div class="agile_top_brand_left_grid1">
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="{{url('/single')}}"><img src="{{asset('/front')}}/images/18.png" alt=" " class="img-responsive" /></a>
                        ...
                        <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                            ...
                            <div class="agile_top_brand_left_grid1">
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="{{url('/single')}}"><img src="{{asset('/front')}}/images/19.png" alt=" " class="img-responsive" /></a>
                        ...
                        <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                            ...
                            <div class="agile_top_brand_left_grid1">
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="{{url('/single')}}"><img src="{{asset('/front')}}/images/20.png" alt=" " class="img-responsive" /></a>
                        ...
                        <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                            ...
                            <div class="agile_top_brand_left_grid1">
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="{{url('/single')}}"><img src="{{asset('/front')}}/images/21.png" alt=" " class="img-responsive" /></a>
                        ...
                        <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                            ...
                            <div class="agile_top_brand_left_grid1">
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="{{url('/single')}}"><img src="{{asset('/front')}}/images/22.png" alt=" " class="img-responsive" /></a>
                        ...
                        <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                            ...
                            <div class="agile_top_brand_left_grid1">
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="{{url('/single')}}"><img src="{{asset('/front')}}/images/23.png" alt=" " class="img-responsive" /></a>
                        ...
                        <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                            ...
                            <div class="agile_top_brand_left_grid1">
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="{{url('/single')}}"><img src="{{asset('/front')}}/images/24.png" alt=" " class="img-responsive" /></a>
                        ...
                        <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                            ...
                            <div class="agile_top_brand_left_grid1">
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="{{url('/single')}}"><img src="{{asset('/front')}}/images/25.png" alt=" " class="img-responsive" /></a>
                        ...
                        <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                            ...
                            <div class="agile_top_brand_left_grid1">
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="{{url('/single')}}"><img src="{{asset('/front')}}/images/26.png" alt=" " class="img-responsive" /></a>
                        ...
                        <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                            ...
                            <div class="agile_top_brand_left_grid1">
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="{{url('/single')}}"><img src="{{asset('/front')}}/images/27.png" alt=" " class="img-responsive" /></a>
                        ...
                        <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                            ...
                            <div class="agile_top_brand_left_grid1">
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="single.html"><img src="{{asset('/front')}}/images/28.png" alt=" " class="img-responsive" /></a>
