                                ...
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="{{url('/single')}}"><img src="{{asset('/front')}}/images/64.png" alt=" " class="img-responsive" /></a>
                        ...
                        <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                            ...
                            <div class="agile_top_brand_left_grid1">
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="{{url('/single')}}"><img src="{{asset('/front')}}/images/65.png" alt=" " class="img-responsive" /></a>
                        ...
                        <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                            ...
                            <div class="agile_top_brand_left_grid1">
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="{{url('/single')}}"><img src="{{asset('/front')}}/images/66.png" alt=" " class="img-responsive" /></a>
                        ...
                        <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                            ...
                            <div class="agile_top_brand_left_grid1">
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="{{url('/single')}}"><img src="{{asset('/front')}}/images/67.png" alt=" " class="img-responsive" /></a>
                        ...
                        <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                            ...
                            <div class="agile_top_brand_left_grid1">
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="{{url('/single')}}"><img src="{{asset('/front')}}/images/68.png" alt=" " class="img-responsive" /></a>
                        ...
                        <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                            ...
                            <div class="agile_top_brand_left_grid1">
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="{{url('/single')}}"><img src="{{asset('/front')}}/images/69.png" alt=" " class="img-responsive" /></a>
                        ...
                        <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                            ...
                            <div class="agile_top_brand_left_grid1">
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="{{url('/single')}}"><img src="{{asset('/front')}}/images/70.png" alt=" " class="img-responsive" /></a>
                        ...
                        <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                            ...
                            <div class="agile_top_brand_left_grid1">
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="{{url('/single')}}/"><img src="{{asset('/front')}}/images/71.png" alt=" " class="img-responsive" /></a>
                        ...
                        <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                            ...
                            <div class="agile_top_brand_left_grid1">
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="{{url('/single')}}"><img src="{{asset('/front')}}/images/72.png" alt=" " class="img-responsive" /></a>
                        ...
                        <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                            ...
                            <div class="agile_top_brand_left_grid1">
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="{{url('/single')}}/"><img src="{{asset('/front')}}/images/73.png" alt=" " class="img-responsive" /></a>
                        ...
                        <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                            ...
                            <div class="agile_top_brand_left_grid1">
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="{{url('/single')}}/"><img src="{{asset('/front')}}/images/74.png" alt=" " class="img-responsive" /></a>
                        ...
                        <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                            ...
                            <div class="agile_top_brand_left_grid1">
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="{{url('/single')}}/"><img src="{{asset('/front')}}/images/75.png" alt=" " class="img-responsive" /></a>
