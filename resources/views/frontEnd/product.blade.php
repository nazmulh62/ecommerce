        ...
        <div class="w3l_banner_nav_right">
            ...
            <div class="w3ls_w3l_banner_nav_right_grid">
                ...
                <div class="w3ls_w3l_banner_nav_right_grid1">
                    <h6>food</h6>
                    @foreach($allPublushedProducts as $allPublushedProduct)
                    <div class="col-md-3 w3ls_w3l_banner_left">
                        <div class="hover14 column">
                            <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                                <div class="agile_top_brand_left_grid_pos">
                                    <img src="{{asset($allPublushedProduct->product_image)}}" alt=" " class="img-responsive" />
                                </div>
                                <div class="agile_top_brand_left_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                <a href="{{url('/front')}}"><img src="{{asset($allPublushedProduct->product_image)}}" alt=" " class="img-responsive" /></a>
                                                <p>{{$allPublushedProduct->product_name}}</p>
                                                <h4>${{$allPublushedProduct->product_price}}.00 <span>$5.00</span></h4>
                                            </div>
                            ...
                            <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                                ...
                                <div class="agile_top_brand_left_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                <a href="single.html"><img src="{{asset('/front')}}/images/9.png" alt=" " class="img-responsive" /></a>
