...
Route::get('/signup','EcommerceController@SignUp');
Route::get('/household','EcommerceController@Household');
Route::get('/vegetables','EcommerceController@Vegetables');
Route::get('/kitchen','EcommerceController@Kitchen');
Route::get('/shortcodes','EcommerceController@Shortcodes');
Route::get('/drinks','EcommerceController@Softdrink');
Route::get('/frozen','EcommerceController@Frozen');
Route::get('/bread','EcommerceController@Bread');
Route::get('/single','EcommerceController@Single');
Route::get('/mail','EcommerceController@Mail');
Route::get('/pet','EcommerceController@Pet');
Route::get('/privacy','EcommerceController@Privacy');
Route::get('/checkout','EcommerceController@Checkout');
Route::get('/payment','EcommerceController@Payment');

//Route::get('/category-product/{id}', 'EcommerceController@Category');
